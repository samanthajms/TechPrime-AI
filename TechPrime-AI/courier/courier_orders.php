                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
                                        <a href="courier_details.php?id=<?php echo (int)$r['oid']; ?>" class="btn btn-outline btn-sm">View</a>
                                        ...
                                        <a href="courier_assign.php" class="btn btn-primary btn-sm">Assign Carrier</a>
                                        <?php endif; ?>
                                    </div>
                                </td>
                            </tr>
