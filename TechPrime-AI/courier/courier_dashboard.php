...
$welcomeName = h($_SESSION['name'] ?? 'Courier');
...
<head>
    ...
    <title>Courier Dashboard - IAS</title>
    <style>
...
<aside class="sidebar">
    ...
    <a href="courier_dashboard.php" class="<?php echo $activeNav === 'dashboard' ? 'active' : ''; ?>">📊 <span>Dashboard</span></a>
    <a href="courier_orders.php" class="<?php echo $activeNav === 'orders' ? 'active' : ''; ?>">🛒 <span>Orders</span></a>
    <a href="courier_assign.php" class="<?php echo $activeNav === 'assign' ? 'active' : ''; ?>">🚚 <span>Delivery Assignment</span></a>
    <a href="courier_history.php" class="<?php echo $activeNav === 'history' ? 'active' : ''; ?>">📜 <span>History</span></a>
