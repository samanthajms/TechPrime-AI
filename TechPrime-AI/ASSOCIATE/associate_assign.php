...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header('Location: associate_orders.php?alert=assigned');
    exit;
}
...
<aside class="sidebar">
    ...
    <a href="associate_assign.php" class="active">🚚 <span>Delivery Assignment</span></a>
...
<div class="main">
    ...
    <div class="card">
        <p style="color:#666;line-height:1.5;">Assign a carrier partner to retail-passed orders. Use <strong>Orders</strong> to track shipment progress; <strong>History</strong> shows completed deliveries only.</p>
        <?php if (empty($orderOptions)): ?>
            <p style="color:#999;font-style:italic;">No unassigned orders. Wait for retail officers to pass orders.</p>
        <?php else: ?>
        <form method="post">
