...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'update_status') {
    ...
    header('Location: courier_orders.php?alert=updated');
    exit;
}
...
<head>
    ...
    <title>Courier Orders - IAS</title>
    <style>
...
<div class="main">
    <header class="topbar"><h2>Orders from Seller</h2></header>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="display:flex;gap:8px;flex-wrap:wrap;align-items:center;">
                        <a href="courier_details.php?id=<?php echo (int)$r['oid']; ?>" class="btn btn-outline">View</a>
                        ...
                        <a href="courier_assign.php" class="btn">Assign Carrier</a>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
